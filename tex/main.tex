...
\begin{tikzpicture}[remember picture,overlay]
    ...
    \node[xshift=2cm,yshift=-3cm] at (current page.north west){
        \psbarcode{*001345751*}{includetext width=2 height=0.5 textsize=15 textgaps=2}{code128}
    };
    \node[xshift=-4cm,yshift=1cm] at (current page.south east){
        \psbarcode{93a0ff04-8149-4a09-be04-2f48aa2e909c}{includetext width=1 height=1}{qrcode}
    };
    \node[xshift=6.5cm,yshift=6cm] at (current page.south west){
        \includegraphics[width=6cm,angle=8]{sign.png}
    };
\end{tikzpicture}
